...
void map_insert_array_(Map *, char const *key, Any array, int count);
#define map_insert_array(map, key, array) map_insert_array_(map, key, array, sizeof array / sizeof array[0]);
